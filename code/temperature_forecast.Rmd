...
```{r loadData}
cherry <- read.csv("../data/FinalizedData/FinalData/Vancouver_climate.csv")
...
precip = cherry$PRCP
temp = cherry$TAVG
date = as.Date(cherry$DATE)
#date = (as.Date(as.character(cherry$DATE)))
year = format(as.Date(cherry$DATE),"%Y")
...
write.csv(data.forecast,"../data/FinalizedData/FinalData/Vancouver_temp_forecast_10_years.csv")
